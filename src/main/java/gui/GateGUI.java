...
public class GateGUI extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        char outputRegisterIFlag = outputRegisterGUI.getInputF();
        ...
        if (inputRegisterOFlag == 'r' && outputRegisterIFlag == 'l') {

        }

        if (inputRegisterOFlag == 't' && outputRegisterIFlag == 't') {
    ...
    public void moveValue () {
        outputRegisterGUI.setValue(inputRegisterGUI.registerField.getText());
    }
}
